          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="user-settings">
              <div class="tile user-settings">
                ...
                <form method="POST" action="{{route('user-profile-information.update')}}">
                  ...
                  <div class="row mb-4">
                    <div class="col-md-4">
                      ...
                      <input name="first_name" value="{{Auth::user()->name}}" class="form-control" type="text">
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8 mb-4">
                      ...
                      <input name="mobile"  value="{{Auth::user()->mobile}}" class="form-control" type="text">
                    </div>
                    <div class="clearfix"></div>
                ...
                <h4 class="line-head">Two Factor Authintication</h4>
                ...
                <h4 class="line-head">Recovery Code</h4>
                <ul>
